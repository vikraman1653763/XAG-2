...
const BatteryDetails = lazy(() =>
  import("./product/Battery/BatteryDetails.jsx")
);
const FlightController = lazy(() =>
  import("./product/FlightController/FlightController.jsx")
);
...
const Surveillance = lazy(() =>
  import("./product/surveillance/Surveillance.jsx")
);
      ...
      <Suspense fallback={<Loader />}>
        <main>
          <Routes>
            ...
            <Route
              path="/admin/careers"
              element={<ProtectedRoute element={CareerList} />}
            />
            <Route
              path="/admin/testimonial"
              element={<ProtectedRoute element={TestimonialList} />}
            />
            <Route
              path="/admin/blogs/new"
              element={<ProtectedRoute element={BlogUpdate} />}
            />
            <Route
              path="/admin/careers/new"
              element={<ProtectedRoute element={CareerUpdate} />}
            />
            <Route
              path="/admin/testimonials/new"
              element={<ProtectedRoute element={TestimonialUpdate} />}
            />
